...
def test_get_listar_produtos():
    ...
    validate(instance=data, schema=schema_lista_produtos)  
...
def test_post_cria_produto_in_3_sec(auth_token):
    ...
    validate(instance=data, schema=schema_produto_criado)  
...
def test_post_cria_produto_repetido(auth_token):
    ...
    validate(instance=dataRepetido, schema=schema_erro) 
...
def test_post_cria_produto_token_ausente():
    ...
    validate(instance=data, schema=schema_erro)  
...
def test_get_produto_por_id(produto_criado):
    ...
    validate(instance=data, schema=schema_produto)  
    assert response.status_code == 200
    assert "_id" in data
